...
public class PutTransactionResponse implements ITransactionResponse{
    ...
    public PutTransactionResponse(long id, long user_id, BigDecimal amount, Games invoicingParty){
        this.id = id;
        this.userId = user_id;
        this.amount = amount;
