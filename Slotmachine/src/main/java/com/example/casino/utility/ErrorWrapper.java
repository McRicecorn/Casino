...
public enum ErrorWrapper {
    ...
    NO_GAMES_FOUND("No games found.", HttpStatus.NOT_FOUND),
    INCONSISTENT_DATA("The provided game data is logically inconsistent.",HttpStatus.BAD_REQUEST),
    INVALID_SLOT_RESULT("The slot result is invalid or empty.", HttpStatus.BAD_REQUEST);
